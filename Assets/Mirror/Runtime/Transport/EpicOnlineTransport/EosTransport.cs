...
namespace EpicTransport
{
  ...
  public class EosTransport : Transport
  {
    ...
    // public override void ClientSend(ArraySegment<byte> segment, int channelId = 1) { }
    ...
    // public override void ServerSend(int connectionId, ArraySegment<byte> segment, int channelId = 1) { }
    ...
    public override void ServerSend(int connectionId, ArraySegment<byte> segment, int channelId)
    {
      if (ServerActive())
      {
        Send(segment, channelId, connectionId);
      }
    }
    ...
    private void Send(ArraySegment<byte> segment, int channelId, int connectionId = int.MinValue)
    {
